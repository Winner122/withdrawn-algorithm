;; funding-milestone.clar
;; WithdrawnAlgorithm: A decentralized crowdfunding platform with progressive milestone releases
;; Enables creators to propose and fund projects through a transparent, staged investment model
;; Supporting two verification modes: community voting and expert reviewer verification.
